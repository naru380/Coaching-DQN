...
class Tetris(object):
    ...
    def _draw_status(self, score: int, level: int) -> None:
        ...
        # If 'antialias' is True, character is cannot draw correctly.
        # score_label_surf = self._font.render(SCORE_LABEL, True, TEXTCOLOR)
        score_label_surf = self._font.render(SCORE_LABEL, False, TEXTCOLOR, None)
        ...
        score_surf = self._font.render(str(score), False, TEXTCOLOR)
        ...
        level_label_surf = self._font.render(LEVEL_LABEL, False, TEXTCOLOR)
        ...
        level_surf = self._font.render(str(level), False, TEXTCOLOR)
    ...
    def _draw_next_piece(self, piece: dict) -> None:
        ...
        next_surf = self._font.render(NEXT_LABEL, False, TEXTCOLOR)
